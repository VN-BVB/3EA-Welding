...
SettingPara::SettingPara() : qSetting(std::make_shared<QSettings>("./data/setting/Parematers.ini", QSettings::IniFormat)) {
    this->loadSetting();
}
...
void SettingPara::loadSetting() {
    if (qSetting != nullptr) {
        ...
        TubeSidePlatFilletWithdrawDistance = qSetting->value("GFSeamPosition/TubeSidePlatFilletWithdrawDistance", TubeSidePlatFilletWithdrawDistance).toDouble();
        ...
        // 正面横梁对接延长
        FrontBeamLeft_ExtendStart =
            qSetting->value("SeamPosition/FrontBeamLeft_ExtendStart", FrontBeamLeft_ExtendStart).toDouble();
        FrontBeamLeft_ExtendEnd = qSetting->value("SeamPosition/FrontBeamLeft_ExtendEnd", FrontBeamLeft_ExtendEnd).toDouble();
        FrontBeamRight_ExtendStart =
            qSetting->value("SeamPosition/FrontBeamRight_ExtendStart", FrontBeamRight_ExtendStart).toDouble();
        FrontBeamRight_ExtendEnd = qSetting->value("SeamPosition/FrontBeamRight_ExtendEnd", FrontBeamRight_ExtendEnd).toDouble();

        // 正面横梁水平延长
        FrontHBeamLeft_ExtendStart =
            qSetting->value("SeamPosition/FrontHBeamLeft_ExtendStart", FrontHBeamLeft_ExtendStart).toDouble();
        FrontHBeamLeft_ExtendEnd = qSetting->value("SeamPosition/FrontHBeamLeft_ExtendEnd", FrontHBeamLeft_ExtendEnd).toDouble();
        FrontHBeamRight_ExtendStart =
            qSetting->value("SeamPosition/FrontHBeamRight_ExtendStart", FrontHBeamRight_ExtendStart).toDouble();
        FrontHBeamRight_ExtendEnd =
            qSetting->value("SeamPosition/FrontHBeamRight_ExtendEnd", FrontHBeamRight_ExtendEnd).toDouble();
        // 正面横梁竖直延长
        FrontVBeamLeft_ExtendStart =
            qSetting->value("SeamPosition/FrontVBeamLeft_ExtendStart", FrontVBeamLeft_ExtendStart).toDouble();
        FrontVBeamLeft_ExtendEnd = qSetting->value("SeamPosition/FrontVBeamLeft_ExtendEnd", FrontVBeamLeft_ExtendEnd).toDouble();
        FrontVBeamRight_ExtendStart =
            qSetting->value("SeamPosition/FrontVBeamRight_ExtendStart", FrontVBeamRight_ExtendStart).toDouble();
        FrontVBeamRight_ExtendEnd =
            qSetting->value("SeamPosition/FrontVBeamRight_ExtendEnd", FrontVBeamRight_ExtendEnd).toDouble();
        // 焊枪后撤
        FrontBeamLeft_WithDrawDistance =
            qSetting->value("SeamPosition/FrontBeamLeft_WithDrawDistance", FrontBeamLeft_WithDrawDistance)
                .toDouble();  // 正面左侧焊枪后撤
        FrontBeamRight_WithDrawDistance =
            qSetting->value("SeamPosition/FrontBeamRight_WithDrawDistance", FrontBeamRight_WithDrawDistance)
                .toDouble();  // 正面右侧焊枪后撤
        ...
        BackBeamRight_ExtendStart =
            qSetting->value("SeamPosition/BackBeamRight_ExtendStart", BackBeamRight_ExtendStart).toDouble();
        ...
        MinDth_IntersectionToStartPoint =
            qSetting->value("SeamPosition/MinDth_IntersectionToStartPoint", MinDth_IntersectionToStartPoint).toDouble();
        ...
        // 工件正面横梁偏移
        Front_Beam_Region1_X_Shift =
            qSetting->value("SeamPosition/Front_Beam_Region1_X_Shift", Front_Beam_Region1_X_Shift).toDouble();
        Front_Beam_Region1_Y_Shift =
            qSetting->value("SeamPosition/Front_Beam_Region1_Y_Shift", Front_Beam_Region1_Y_Shift).toDouble();
        Front_Beam_Region1_Z_Shift =
            qSetting->value("SeamPosition/Front_Beam_Region1_Z_Shift", Front_Beam_Region1_Z_Shift).toDouble();
        ...
        Front_Beam_Region2_X_Shift =
            qSetting->value("SeamPosition/Front_Beam_Region2_X_Shift", Front_Beam_Region2_X_Shift).toDouble();
        Front_Beam_Region2_Y_Shift =
            qSetting->value("SeamPosition/Front_Beam_Region2_Y_Shift", Front_Beam_Region2_Y_Shift).toDouble();
        Front_Beam_Region2_Z_Shift =
            qSetting->value("SeamPosition/Front_Beam_Region2_Z_Shift", Front_Beam_Region2_Z_Shift).toDouble();
        ...
        // 工件反面横梁偏移
        Back_Beam_Region1_X_Shift =
            qSetting->value("SeamPosition/Back_Beam_Region1_X_Shift", Back_Beam_Region1_X_Shift).toDouble();
        Back_Beam_Region1_Y_Shift =
            qSetting->value("SeamPosition/Back_Beam_Region1_Y_Shift", Back_Beam_Region1_Y_Shift).toDouble();
        Back_Beam_Region1_Z_Shift =
            qSetting->value("SeamPosition/Back_Beam_Region1_Z_Shift", Back_Beam_Region1_Z_Shift).toDouble();
        Back_Beam_Region2_X_Shift =
            qSetting->value("SeamPosition/Back_Beam_Region2_X_Shift", Back_Beam_Region2_X_Shift).toDouble();
        Back_Beam_Region2_Y_Shift =
            qSetting->value("SeamPosition/Back_Beam_Region2_Y_Shift", Back_Beam_Region2_Y_Shift).toDouble();
        Back_Beam_Region2_Z_Shift =
            qSetting->value("SeamPosition/Back_Beam_Region2_Z_Shift", Back_Beam_Region2_Z_Shift).toDouble();
        ...
        // 工件正面横梁偏移
        Front_Beam_Region1_X_Shift_R =
            qSetting->value("SeamPosition/Front_Beam_Region1_X_Shift_R", Front_Beam_Region1_X_Shift_R).toDouble();
        Front_Beam_Region1_Y_Shift_R =
            qSetting->value("SeamPosition/Front_Beam_Region1_Y_Shift_R", Front_Beam_Region1_Y_Shift_R).toDouble();
        Front_Beam_Region1_Z_Shift_R =
            qSetting->value("SeamPosition/Front_Beam_Region1_Z_Shift_R", Front_Beam_Region1_Z_Shift_R).toDouble();
        Front_Beam_Region2_X_Shift_R =
            qSetting->value("SeamPosition/Front_Beam_Region2_X_Shift_R", Front_Beam_Region2_X_Shift_R).toDouble();
        Front_Beam_Region2_Y_Shift_R =
            qSetting->value("SeamPosition/Front_Beam_Region2_Y_Shift_R", Front_Beam_Region2_Y_Shift_R).toDouble();
        Front_Beam_Region2_Z_Shift_R =
            qSetting->value("SeamPosition/Front_Beam_Region2_Z_Shift_R", Front_Beam_Region2_Z_Shift_R).toDouble();

        // 工件反面横梁偏移
        Back_Beam_Region1_X_Shift_R =
            qSetting->value("SeamPosition/Back_Beam_Region1_X_Shift_R", Back_Beam_Region1_X_Shift_R).toDouble();
        Back_Beam_Region1_Y_Shift_R =
            qSetting->value("SeamPosition/Back_Beam_Region1_Y_Shift_R", Back_Beam_Region1_Y_Shift_R).toDouble();
        Back_Beam_Region1_Z_Shift_R =
            qSetting->value("SeamPosition/Back_Beam_Region1_Z_Shift_R", Back_Beam_Region1_Z_Shift_R).toDouble();
        Back_Beam_Region2_X_Shift_R =
            qSetting->value("SeamPosition/Back_Beam_Region2_X_Shift_R", Back_Beam_Region2_X_Shift_R).toDouble();
        Back_Beam_Region2_Y_Shift_R =
            qSetting->value("SeamPosition/Back_Beam_Region2_Y_Shift_R", Back_Beam_Region2_Y_Shift_R).toDouble();
        Back_Beam_Region2_Z_Shift_R =
            qSetting->value("SeamPosition/Back_Beam_Region2_Z_Shift_R", Back_Beam_Region2_Z_Shift_R).toDouble();
        ...
        // 不同焊缝焊接速度
        Value_WeldingSpeed0To1 = qSetting->value("Welding/Value_WeldingSpeed0To1", Value_WeldingSpeed)
                                     .toDouble();                         // 焊接速度(焊缝宽度1mm以下用这个速度)
        ...
        Value_WeldingSpeed1To3 = qSetting->value("Welding/Value_WeldingSpeed1To3", Value_WeldingSpeed)
                                     .toDouble();                         // 焊接速度(焊缝宽度1mm到3mm用这个速度)
        ...
        Value_WeldingSpeed3To5 = qSetting->value("Welding/Value_WeldingSpeed3To5", Value_WeldingSpeed)
                                     .toDouble();                         // 焊接速度(焊缝宽度3mm到5mm用这个速度)
        ...
        Value_WeldingSpeedHorizontal = qSetting->value("Welding/Value_WeldingSpeedHorizontal", Value_WeldingSpeed)
                                           .toDouble();                               // 焊接速度(水平焊缝用这个速度)
        ...
        Value_WeldingCurrent_Vertical = qSetting->value("Welding/Value_WeldingCurrent_Vertical", Value_WeldingCurrent_Vertical)
                                            .toDouble();  // 焊接电流(竖直焊缝用这个电流)
        ...
        Value_WeldingVoltage_Vertical = qSetting->value("Welding/Value_WeldingVoltage_Vertical", Value_WeldingVoltage_Vertical)
                                            .toDouble();  // 焊接电压(竖直焊缝用这个电压)
